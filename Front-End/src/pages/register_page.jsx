...
*/
  ...
  - Removed the old prop-based navigation (onRegistered and onSignInClick).
  - Added useNavigate() from react-router-dom.
  - Register button now navigates to the Verification page.
  - "Have an Account? Sign In Here!" navigates to the Sign In page.
  - Added a Back button to return to the Landing Page.
  - This makes navigation work with browser history and page URLs.
*/
...
function RegisterPage() {
  ...
  function handleRegister(e) {
    ...
    // Later you'll add Firebase registration here
      ...
      <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
        ...
        <div>
          ...
          <p className="mb-6 font-semibold text-neutral-600">
            Take a clear photo of your UML ID and upload it below.
            After verification, you will be allowed to register an account.
          </p>
